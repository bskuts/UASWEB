...
$que_produk = "SELECT produk.nama_produk AS nama, SUM(detail_pesanan.jumlah_produk) AS jumlah_penjualan
FROM detail_pesanan
...
$que_kategori = "SELECT kategori.nama_kategori AS nama, SUM(detail_pesanan.jumlah_produk) AS jumlah_penjualan
FROM detail_pesanan
JOIN pesanan ON pesanan.id_pesanan = detail_pesanan.id_pesanan
JOIN produk ON produk.id_produk = detail_pesanan.id_produk
JOIN kategori ON kategori.id_kategori = produk.id_kategori
