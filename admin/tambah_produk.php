...
<form action="index_admin.php?page=tambah_produk" method="post" enctype="multipart/form-data">
...
if(isset($_POST['submit'])) 
{
	...
	$result = mysqli_query($con, "INSERT INTO produk (nama_produk, deskripsi_produk, harga, stok, id_kategori, gambar_produk) VALUES ('$nama','$deskripsi','$harga','$stok','$kategori','$gambar')");
