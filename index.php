  ...
  <header>
    ...
    <div class="container">
        ...
        <?php  
          ...
          <a class="navbar-brand" href="#"><img src="image/logo1.png" class="logo-nav"></a>
          <ul>
            <li><a href="home.php?id=<?php echo $pelanggan?>&username=<?php echo $user?>&nama=<?php echo $nama?>">Beranda</a></li>
            <li><a href="About.php?id=<?php echo $pelanggan?>&username=<?php echo $user?>&nama=<?php echo $nama?>">Tentang Kami</a></li>
            <li><a href="Index.php?id=<?php echo $pelanggan?>&username=<?php echo $user?>&nama=<?php echo $nama?>"><b>Layanan</b></a></li>
            <li><a href="Kontak.php?id=<?php echo $pelanggan?>&username=<?php echo $user?>&nama=<?php echo $nama?>">Kontak</a></li>
            <li><img src="image/user-2.png"></li>
            <li><p class="navbar-brand" href="index.php"><?php echo $nama ?></p></li>
